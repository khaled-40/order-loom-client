...
const Login = () => {
    const { signInWithGoogle, signInUser, loading } = useAuth();
        ...
        <div>
            <form className='px-12' onSubmit={handleSubmit(handleRegistration)}>
                ...
                <fieldset className="fieldset">
                    ...
                    <button className="btn btn-primary text-white mt-4">{loading?<span className="loading loading-spinner text-neutral"></span>:'Login'}</button>
                </fieldset>
            </form>
